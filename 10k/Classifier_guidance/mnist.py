...
# ============================================================================
# CONFIGURATION - CHANGED FOLDER NAME AND TRAINING PARAMETERS
# ============================================================================

OUTPUT_FOLDER = 'mnist_flow_50ep'  # Changed folder name for MNIST
NUM_EPOCHS_FLOW = 50  # Changed from 1 to 50
NUM_EPOCHS_CLASSIFIER = 50  # Changed from 1 to 50
NUM_SAMPLES_EVAL = 10000  # Changed from 50 to 10000
...
class ImprovedMNISTFlowClassifier(nn.Module):
    ...
    def __init__(
        ...
        # Initial convolution - NOTE: 1 channel for MNIST
...
def visualize_samples(model, classifier, num_samples=64):
    ...
    for class_idx, class_name in class_pbar:
        ...
        save_image(grid, f'{OUTPUT_FOLDER}/samples/digit_{class_name}_conditional.png')
...
def main():
    ...
    if os.path.exists(f'{OUTPUT_FOLDER}/checkpoints/flow_final.pt'):
        print("Loading pre-trained flow model...")
        checkpoint = torch.load(f'{OUTPUT_FOLDER}/checkpoints/flow_final.pt', map_location=device)
        ...
        }, f'{OUTPUT_FOLDER}/checkpoints/flow_final.pt')
    ...
    checkpoint_path = f'{OUTPUT_FOLDER}/checkpoints/deep_classifier_v2_final.pt'
    ...
    with open(f'{OUTPUT_FOLDER}/results/improved_comprehensive_results.txt', 'w') as f:
    ...
    print("COMPLETE!")
    print("="*80)
    print(f"Results saved to '{OUTPUT_FOLDER}/results/improved_comprehensive_results.txt'")
    print(f"Visualizations saved to '{OUTPUT_FOLDER}/samples/' directory")
    print(f"Model checkpoints saved to '{OUTPUT_FOLDER}/checkpoints/' directory")
    print(f"{NUM_SAMPLES_SAVE} individual samples saved to '{OUTPUT_FOLDER}/generated_samples/' directory")
